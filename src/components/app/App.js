            ...
            <Switch>
              <Route exact path="/">
               ...
               <div className="stepbByStep" align="right"> 
                   <a className="goToStepByStep" href="#" onClick={handleClickNastepny}> Następny (start) </a>
                </div>           
     
               <div className="stepbByStep" align="right"> 
                   <a className="goToStepByStep" href="#" onClick={handleClickPoprzedni}> Poprzedni (stop) </a>
                </div>
